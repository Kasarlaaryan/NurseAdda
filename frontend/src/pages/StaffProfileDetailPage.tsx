        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm font-bold text-sky-600 dark:text-sky-400 mt-1">{staff.staffCategory}</p>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="p-4 rounded-2xl bg-sky-50/50 dark:bg-sky-900/10 border border-sky-100/50 dark:border-sky-900/30">
                    <p className="text-[10px] uppercase font-bold text-sky-600 dark:text-sky-400 tracking-widest mb-1">Staff Category</p>
                      ...
                      {allDocs.map((doc, idx) => (
                        <div key={idx} className="p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors group">
                          ...
                          <Button 
                            variant="ghost" 
                            size="sm" 
                            className="h-8 w-8 p-0 text-slate-400 hover:text-sky-500"
