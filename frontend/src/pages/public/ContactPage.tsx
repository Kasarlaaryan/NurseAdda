      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-24">
              ...
              <CardContent className="p-8 md:p-12">
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <input 
                        type="text" 
                        required
                        className="w-full h-14 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl px-6 font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                  ...
                  <div className="space-y-3">
                    ...
                    <select className="w-full h-14 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl px-6 font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500/20 appearance-none">
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea 
                      required
                      rows={6}
                      className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl p-6 font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                      placeholder="Tell us how we can help..."
                    ></textarea>
                  </div>

                  <Button type="submit" size="lg" className="h-14 px-12 text-lg font-black shadow-xl shadow-amber-500/20" rightIcon={<Send className="w-5 h-5" />}>
                    Send Message
                  </Button>
                </form>
              </CardContent>
          ...
          <div className="space-y-8">
            <div className="p-10 rounded-[48px] bg-amber-600 text-white shadow-2xl shadow-amber-500/20">
              ...
              <div className="space-y-10">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-amber-200 mb-1">Email Us</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-amber-200 mb-1">Call Us</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-amber-200 mb-1">Visit Us</p>
