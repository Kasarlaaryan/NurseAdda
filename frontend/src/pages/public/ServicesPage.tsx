      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <h1 className="mt-8 text-5xl font-black text-slate-900 dark:text-white tracking-tight">
            ...
            <span className="text-sky-600">Enterprise Solutions</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {[
            ...
            <Card key={i} className="group hover:border-sky-500/50 transition-all border-none bg-white dark:bg-slate-900 overflow-hidden shadow-none">
              <CardContent className="p-8">
                ...
                <Button variant="ghost" size="sm" className="text-sky-600 font-black tracking-widest uppercase text-[10px] p-0 h-auto hover:bg-transparent" rightIcon={<ChevronRight className="w-3 h-3" />}>
                  Learn More
                </Button>
              </CardContent>
            </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="p-12 rounded-[48px] bg-slate-900 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <Button size="lg" className="h-14 px-10 text-lg font-black bg-sky-600 hover:bg-sky-700 shadow-xl shadow-sky-900/20">
                Contact Sales
              </Button>
            </div>
          </div>
          <div className="p-12 rounded-[48px] bg-sky-600 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-sky-50 font-medium text-sm">
                    <CheckCircle2 className="w-5 h-5 text-white flex-shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
              <Button size="lg" className="h-14 px-10 text-lg font-black bg-white text-sky-600 hover:bg-slate-50 shadow-xl shadow-sky-900/20">
                Partner with us
              </Button>
            </div>
          </div>
